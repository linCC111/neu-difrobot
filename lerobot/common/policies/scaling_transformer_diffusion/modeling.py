...
from lerobot.common.policies.scaling_transformer_diffusion.configuration import ScalingTransformerDiffusionConfig as STDConfig
from lerobot.common.policies.normalize import Normalize, Unnormalize
import lerobot.common.policies.scaling_transformer_diffusion.tinydiffp as dfp
...
class TransformerDiffusionPolicy(nn.Module, PyTorchModelHubMixin):
    ...
    def __init__(
        self,
        config: Optional[STDConfig] = None,
        ...
        self.model = ScalingTransformerDiffusion(config)
...
class ScalingTransformerDiffusion(nn.Module):
